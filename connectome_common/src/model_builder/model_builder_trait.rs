...
use crate::model_builder::ModelBuilderType;
...
pub use super::model_builder_base::ModelBuilder;
    ...
    Ix: Clone + IndexType,
{
    ...
    fn perform_action(&mut self) {
        if let ModelBuilderType::Builder = self.type_of {
            let nodes_to_add: Vec<Node<PatternContent>> = Vec::new();
...
mod tests {
    ...
    fn test_model_builder_creation() {
        ...
        let (tx, _) = channel::<GraphChangeRequest<String, usize>>();
